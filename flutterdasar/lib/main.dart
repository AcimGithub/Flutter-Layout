...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'BolaBeracun'),
    );
  }
}
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  child: const Text(
                    "5 Pesepak bola dengan agama ISLAM",
                    style: TextStyle(
                    ...
                    children: [
                      Container(
                        decoration: const BoxDecoration(
                          image: DecorationImage(
                              image: AssetImage(
                                  'assets/images/halanmondok.jpeg'),
                              fit: BoxFit.fitWidth),
                        ),
                        width: 150,
                        height: 150,
                    ...
                    children: [
                      Container(
                        decoration: const BoxDecoration(
                          image: DecorationImage(
                              image: AssetImage(
                                  'assets/images/ronaldomondok.jpeg'),
                              fit: BoxFit.fitWidth),
                        ),
                        width: 150,
                        height: 150,
